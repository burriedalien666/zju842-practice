...
function add(relative){
  ...
  if(/(^|\/)(node_modules|\.git|userdata|data|releases|\.test-artifacts)(\/|$)|\.sqlite(?:-|$)|\.log$|\.pdf$/.test(relative)||relative.split('/').some(p=>p.startsWith('.env')&&p!=='.env.example'))throw new Error('不应打包的文件：'+relative);
